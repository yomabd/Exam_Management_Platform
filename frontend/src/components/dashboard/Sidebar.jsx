...
const Sidebar = ({handleSelectedComponent, selectedComponent, barOn}) => {
  return (
    <div className={`bg-gray-800 text-white -64 space-y-6 py-7 px-2 md:min-h-screen fixed hidden md:block ${barOn?'max-md:block':''} top-0 left-0 w-[200px] pt-[130px] bottom-0 z-[1]`}>
